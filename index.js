...
app.get("/filter",(req,res)=>{
  ...
  const fileredActivities=jokes.filter((joke)=>joke.jokeType===type);
  res.json(fileredActivities);
});
...
app.put("/jokes/:id",(req,res)=>{
  const id=parseInt(req.params.id);
  (jokes.find((joke)=>joke.id===id)).text=req.body["text"];
  (jokes.find((joke)=>joke.id===id)).text=req.body["type"];
});
...
app.patch("/jokes/:id",(req,res)=>{
  ...
  const replacementJoke={
    ...
    jokeType:req.body["body"]||existingJoke.jokeType,
  };
